...
public class AuthorHateoasDto {
    ...
    public AuthorHateoasDto() {}

    public AuthorHateoasDto(Long id, String name, List<BookHateoasDto> books) {
        this.id = id;
        this.name = name;
        this.books = books;
    }
    ...
    public void addLink(String delete, String s) {
